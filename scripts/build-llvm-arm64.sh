...
cmake -S "$LLVM_SOURCE_DIR/llvm" \
    ...
    -DCMAKE_CXX_FLAGS_RELEASE="-O3 -march=native -mtune=native -flto=thin -fomit-frame-pointer -fno-plt -fno-semantic-interposition -fvisibility=hidden -DNDEBUG -stdlib=libc++" \
